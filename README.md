...
当前主线版本：**Windows 1.0.14**（.NET 10 / WinForms）。macOS 以 **Avalonia + 共享 Core** 推进；仓库里仍保留早期 Swift/AppKit 原型。
...
- 当前 Windows 程序版本见 `Quickstart/Quickstart.csproj` 的 `<Version>`（现为 **1.0.14**）。
