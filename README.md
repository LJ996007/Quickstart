...
![Version](https://img.shields.io/badge/version-1.0.18-green)
...
当前主线版本：**Windows 1.0.18**（.NET 10 / WinForms）。
...
- 当前 Windows 程序版本见 `Quickstart/Quickstart.csproj` 的 `<Version>`（现为 **1.0.18**）。
